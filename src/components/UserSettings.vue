        ...
        <form>
          <ion-list>
            ...
            <ion-item>
              ...
              <ion-input type="password" v-model="password" placeholder="Voer je nieuwe wachtwoord in"></ion-input>
            </ion-item>
            <ion-item>
              <ion-label>Geboortedatum</ion-label>
              <ion-datetime v-model="birthdate" display-format="YYYY-MM-DD" placeholder="Selecteer je geboortedatum"></ion-datetime>
            </ion-item>
            <ion-item>
